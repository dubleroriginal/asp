       ...
       private DevicesContext dbconnect = new DevicesContext();
        ...
        public ActionResult Index()
        {
            ...
            if (Session["Figures"] == null)
            {
                ...
                deviceList.Add(2, new Models.Devices.StereoSystem("Стерео система"));
                deviceList.Add(3, new Models.Devices.AirConditioning("Кондиционер"));
                deviceList.Add(4, new Models.Devices.TeleVision("Телевизор",new Models.Devices.Bluray("bluray"),Models.Addition.Chanel.ICTV));
        ...
        public ActionResult Add(string type, string Namedevice)
        {
            ...
            {
                case"cond":
                    deviceList.Add(ID, new Models.Devices.AirConditioning(Namedevice)); 
                     ID++;
                    Session["nextID"] = ID;
                    Session["Devices"] = deviceList;
                    break;
                case "tr":
                    deviceList.Add(ID, new Models.Devices.StereoSystem(Namedevice)); 
                     ID++;
                    Session["nextID"] = ID;
                    Session["Devices"] = deviceList;
                    break;
                ...
                case "kettle":
                    ...
                    break;
                case "tv":
                    deviceList.Add(ID, new Models.Devices.TeleVision(Namedevice, new Models.Devices.Bluray(Namedevice + ID), Models.Addition.Chanel.ICTV));  
                     ID++;
                    Session["nextID"] = ID;
                    Session["Devices"] = deviceList;
                    break;
